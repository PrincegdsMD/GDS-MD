...
∘ _${usedPrefix}letra | lirik *text*_
...
rows: [{ 
title: `${1 + index <= 33 ? '🙂' : user.premiumTime > 0 ? '🙂' : '⚠️'} ${lenguajeGB.lenguaje() == 'es' ? temaX[index][0].toUpperCase() : temaX[index][1].toUpperCase()} ${1 + index <= 33 ? '🥵' : user.premiumTime > 0 ? '🥵🎟️' : '⚠️'} • ${lenguajeGB['smsBotonM7']()} ➜ ${user.premiumTime > 0 ? '✅' : '❌'}`, 
...
} if (command == 'convertermenu'){ //convertidor
...
∘ _${usedPrefix}play | play2 *text and link*_
∘ _${usedPrefix}play.1 *text and link*_
∘ _${usedPrefix}play.2 *text and link*_ 
...
∘ _${usedPrefix}instagram *link video and image*_
∘ _${usedPrefix}verig | igstalk *username*_
∘ _${usedPrefix}ighistoria | igstory *username*_
...
handler.command = ['audioefectomenu', 'buscarmenu', 'convertidormenu', 'dlmenu', 'gamesmenu', 'gpmenu',
