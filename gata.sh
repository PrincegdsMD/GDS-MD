...
if wget -q https://github.com/PRINCE-GDS/GDS-MD/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/PRINCE-GDS/GDS-MD.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} GDS-MD${b}: "
	read opcion
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/Jo5bmHMAlZpEIp75mKbwxP &>> /dev/null
...
echo -e "\033[01;32m\033[01mIniciando GDS-MD!!\nStarting GDSBOT!!\n\033[0m"
npm start
