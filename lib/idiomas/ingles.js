...
const smsConfi10 = () => { return `* 𓆩 𓅓 𓆪 𝘾𝙊𝙉𝙁𝙄𝙂𝙐𝙍𝘼𝙏𝙄𝙊𝙉 𝘾𝙀𝙉𝙏𝙀𝙍 𓆩 𓅓 𓆪*`}
const smsParaAdmins = () => { return `*_𝙁𝙊𝙍 𝘼𝘿𝙈𝙄𝙉𝙎 𝘼𝙉𝘿 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 : 𝙂𝙍𝙊𝙐𝙋𝙎_*`}
const smsParaAdYOw = () => { return `*_𝙁𝙊𝙍 𝘼𝘿𝙈𝙄𝙉𝙎 𝘼𝙉𝘿 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 : 𝘾𝙃𝘼𝙏𝙎_*`}
const smsParaOw = () => { return `*_𝙁𝙊𝙍 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 : 𝘾𝙃𝘼𝙏𝙎_*`}
