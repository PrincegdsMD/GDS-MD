...
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *𝙇𝙀𝙁𝙏 𝙏𝙃𝙀 𝙂𝙍𝙊𝙐𝙋, 𝘾𝙊𝙈𝙀 𝘽𝘼𝘾𝙆 𝙎𝙊𝙊𝙉 𝘽𝙔𝙀 𝘽𝙔𝙀* 😎\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
...
const smsConfi3 = () => { return `┃ *𝙎𝙀𝙇𝙀𝘾𝙏 𝘼𝙉 𝙊𝙋𝙏𝙄𝙊𝙉 𝙁𝙍𝙊𝙈 𝙏𝙃𝙀 𝙇𝙄𝙎𝙏*`}
const smsConfi4 = () => { return `┃ *𝙏𝙊 𝙎𝙏𝘼𝙍𝙏 𝙏𝙊 𝘾𝙊𝙉𝙁𝙄𝙂𝙐𝙍𝙀*`}
const smsConfi5 = () => { return `┃● *𝘾𝙊𝙉𝙁𝙄𝙂𝙐𝙍𝘼𝙏𝙄𝙊𝙉 𝙉𝙊𝙏𝙄𝘾𝙀𝙎:*`}
const smsConfi6 = () => { return `┃ ✅ ⇢ *𝙁𝙐𝙉𝘾𝙏𝙄𝙊𝙉 𝙀𝙉𝘼𝘽𝙇𝙀𝘿*`}
const smsConfi7 = () => { return `┃ ❌ ⇢ 𝙁𝙐𝙉𝘾𝙏𝙄𝙊𝙉 𝘿𝙄𝙎𝘼𝘽𝙇𝙀𝘿`}
const smsConfi8 = () => { return `┃ ⚠️ ⇢ 𝙏𝙃𝙄𝙎 𝘾𝙃𝘼𝙏 𝙄𝙎 𝙉𝙊𝙏 𝘼 𝙂𝙍𝙊𝙐𝙋`}
const smsConfi9 = () => { return `┃ **ᎡᎬᏟϴᎷᎷᎬΝᎠᎪͲᏆϴΝ: Ͳϴ ՏᎬᎬ ᏟϴΝҒᏆᏀႮᎡᎪͲᏆϴΝ*\n┃ *ᏟϴᎷᏢᏞᎬͲᎬ ႮՏᎬ ͲᎻᏆՏ ᏀᎡϴႮᏢ ᎷᎬΝႮ*\n┃`}
const smsConfi10 = () => { return `* ❇️ 𓅓 𓆪 𝘾𝙊𝙉𝙁𝙄𝙂𝙐𝙍𝘼𝙏𝙄𝙊𝙉 𝘾𝙀𝙉𝙏𝙀𝙍 𓆩 𓅓 ❇️*`}
const smsParaAdmins = () => { return `𝙁𝙊𝙍 𝘼𝘿𝙈𝙄𝙉𝙎 𝘼𝙉𝘿 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 : 𝙂𝙍𝙊𝙐𝙋𝙎`}
const smsParaAdYOw = () => { return `𝙁𝙊𝙍 𝘼𝘿𝙈𝙄𝙉𝙎 𝘼𝙉𝘿 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 : 𝘾𝙃𝘼𝙏𝙎`}
const smsParaOw = () => { return `𝙁𝙊𝙍 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 : 𝘾𝙃𝘼𝙏𝙎`}
