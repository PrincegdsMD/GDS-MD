...
//_allantilink.js
const smsTextoYT = () => { return '😻 Super GDS-MD - WhatsApp '}
const smsApagar = () => { return '❌ *_DEACTIVATED_*'}
const smsEncender = () => { return '✅ *_ACTIVATED_*'}
...
const smsConfi3 = () => { return `┃ *sᴇʟᴇᴄᴛ ᴀɴ ᴏᴘᴛɪᴏɴ ғʀᴏᴍ ᴛʜᴇ ʟɪsᴛ*`}
const smsConfi4 = () => { return `┃ * ᴛᴏ sᴛᴀʀᴛ ᴛᴏ ᴄᴏɴғɪɢᴜʀᴇ *`}
const smsConfi5 = () => { return `┃● *ᴄᴏɴғɪɢᴜʀᴀᴛɪᴏɴ ɴᴏᴛɪᴄᴇs:*`}
const smsConfi6 = () => { return `┃ ✅ ⇢ *ғᴜɴᴄᴛɪᴏɴ ᴇɴᴀʙʟᴇᴅ*`}
const smsConfi7 = () => { return `┃ ❌ ⇢ *ғᴜɴᴄᴛɪᴏɴ ᴅɪsᴀʙʟᴇᴅ*`}
...
const smsParaAdmins = () => { return `*_FOR ADMINS AND CREATOR : GROUPS_*`}
const smsParaAdYOw = () => { return `*_FOR ADMINS AND CREATOR : CHATS_*`}
const smsParaOw = () => { return `*_FOR CREATOR : CHATS_*`}
const smsNoGg = () => { return ` | ⚠️`}
const smsMens1 = () => { return `*_COMMAND_* `} 
const smsMens2 = () => { return `*_CURRENTLY_* `} 
const smsMens3 = () => { return `*_IN THIS_* `} 
const smsMens4 = () => { return `*_BOT_* `} 
const smsMens5 = () => { return `*_CHAT_* `} 
