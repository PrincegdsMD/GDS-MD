...
if (!text) throw `${mg}𝙒𝙍𝙄𝙏𝙀 𝙏𝙃𝙀 𝙉𝘼𝙈𝙀 𝙊𝙍 𝙏𝙄𝙏𝙇𝙀\n🧊𝙀𝙓𝘼𝙈𝙋𝙇𝙀\n*${usedPrefix + command} Bardo jholi mere ya Muhammad SAWW Naat*`
try {
if (command == 'song') {
conn.reply(m.chat, `${eg}🟢𝙒𝘼𝙄𝙏 𝘼 𝙈𝙊𝙈𝙀𝙉𝙏 𝙁𝙊𝙍 𝙏𝙃𝙀 𝘼𝙐𝘿𝙄𝙊 𝙋𝙇𝙀𝘼𝙎𝙀`, m, {
...
m.reply(`${fg}❗𝙏𝙍𝙔 𝘼𝙂𝘼𝙄𝙉`)
handler.limit = 0 //No gastada limite si fallas
}}
handler.help = ['song' , 'video2'].map(v => v + ' <text>')
handler.tags = ['downloader']
handler.command = ['song', 'video2']
handler.limit = 1
